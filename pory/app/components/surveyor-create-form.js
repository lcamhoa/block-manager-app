    ...
    actions: {
        validate()
        {
            ...
            if (! title.trim().length) {
                ...
                Ember.$('#createSurveyorModalTitle').focus();
            ...
            if (! firstName.trim().length) {
                ...
                Ember.$('#createSurveyorModalFirstName').focus();
            ...
            if (! surname.trim().length) {
                ...
                Ember.$('#createSurveyorModalSurname').focus();
            ...
            if (! company.trim().length) {
                ...
                Ember.$('#createSurveyorModalCompany').focus();
            ...
            if (! telephone.trim().length) {
                ...
                Ember.$('#createSurveyorModalTelephone').focus();
            ...
            if (! mobile.trim().length) {
                ...
                Ember.$('#createSurveyorModalMobile').focus();
            ...
            if (! fax.trim().length) {
                ...
                Ember.$('#createSurveyorModalFax').focus();
            ...
            if (! email.trim().length) {
                ...
                Ember.$('#createSurveyorModalEmail').focus();
            ...
            if (! house.trim().length) {
                ...
                Ember.$('#createSurveyorModalHouse').focus();
            ...
            if (! street.trim().length) {
                ...
                Ember.$('#createSurveyorModalStreet').focus();
            ...
            if (! locality.trim().length) {
                ...
                Ember.$('#createSurveyorModalLocality').focus();
            ...
            if (! town.trim().length) {
                ...
                Ember.$('#createSurveyorModalTown').focus();
            ...
            if (! county.trim().length) {
                ...
                Ember.$('#createSurveyorModalCounty').focus();
            ...
            if (! postcode.trim().length) {
                ...
                Ember.$('#createSurveyorModalPostcode').focus();
            ...
            // There were no errors
                ...
                Ember.$('#createSurveyorAlertSuccess').attr('hidden', false).fadeIn();
                ...
                Ember.$('#createSurveyorModal').modal('hide');
                ...
                {
                    // Fade it out
                    Ember.$('#createSurveyorAlertSuccess').fadeOut({
                        complete: function()
                        {
